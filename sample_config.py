...
class Config(object):
    ...
    # set this with required deadly repo link
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/deadly-fighters/Deadly-Userbot.git"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Deadly")
    # for custom thumb image set this with your required thumb telegraoh link
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/cfdc5cda4f77e6094f9e7.jpg"
    )
    ...
    # Google Drive plugin https://telegra.ph/G-Drive-guide-for-Deadly-01-01
