...
class DeadlyClient(TelegramClient):
    def deadly_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**Deadly Error report**\n\n"
                        link = "[here](https://t.me/deadly_userbot)"
            ...
            if pattern is not None:
                ...
                if edited:
                    deadlyub.add_event_handler(func, events.MessageEdited(**kwargs))
                deadlyub.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                deadlyub.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                deadlyub.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
DeadlyClient.fast_download_file = download_file
DeadlyClient.fast_upload_file = upload_file
DeadlyClient.reload = restart_script
DeadlyClient.get_msg_link = get_message_link
DeadlyClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    DeadlyClient.send_message = send_message
    DeadlyClient.send_file = send_file
    DeadlyClient.edit_message = edit_message
