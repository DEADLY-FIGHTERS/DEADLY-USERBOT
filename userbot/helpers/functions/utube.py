...
async def yt_search(deadly):
    try:
        deadly = urllib.parse.quote(deadly)
        html = urllib.request.urlopen(
            "https://www.youtube.com/results?search_query=" + deadly
        )
...
async def yt_data(deadly):
    params = {"format": "json", "url": deadly}
