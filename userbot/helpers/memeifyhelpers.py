...
from .utils import _deadlyutils
...
async def deadly_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def deadly_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
