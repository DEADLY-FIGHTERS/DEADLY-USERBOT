...
PROGQUOTES = [
    ...
    "Most software today is very much like an Egyptian pyramid with mildeadlys of bricks piled on top of each other, with no structural integrity, but just done by brute force and thousands of slaves.",
...
INSULT_STRINGS = [
    ...
    "Try playing deadlych and throw with RDX its fun.",
