    ...
    while max_try < 5:
        ...
        try:
            ...
            return await edit_delete(
                event,
                "**(ノಠ益ಠ)ノ  Tou sure this a vaid deadlyagory/subreddit ??**",
                time=20,
            )
        ...
        try:
            ...
            if max_try == 5:
                await edit_delete(
                    event,
                    "**ಥ‿ಥ   Sorry i could'nt found, try with difference deadlyagory**",
                )
...
async def bad(event):
    ...
    try:
        ...
        return await edit_delete(
            event, "**(ノಠ益ಠ)ノ  Tou sure this a vaid deadlyagory/subreddit ??**", time=20
        )
    i = 0
