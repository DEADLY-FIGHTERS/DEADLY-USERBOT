# pm and tagged messages logger for Deadly by @deadly-fighters (@deadly-fighters)
import asyncio
...
@deadlyub.deadly_cmd(incoming=True, func=lambda e: e.mentioned, edited=False, forword=None)
