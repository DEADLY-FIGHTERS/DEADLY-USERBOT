...
async def some(event):
    ...
    deadlyevent = await edit_or_reply(event, "`Sending gif....`")
    ...
    for items in rlist:
        ...
        await _deadlyutils.unsavegif(event, nood)
...
async def some(event):
    ...
    deadlyevent = await edit_or_reply(event, "`Wait babe...`😘")
