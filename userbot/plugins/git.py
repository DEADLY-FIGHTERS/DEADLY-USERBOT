...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "Click [here](https://github.com/deadly-fighters/Deadly-Userbot) to open this bot source code\
        \nClick [here](https://github.com/deadly-fighters/Deadly-Userbot) to open supported link for heroku",
    )
...
@deadlyub.deadly_cmd(
    ...
    info={
        ...
        "examples": [".github deadly-fighters", ".github -l5 deadly-fighters"],
    },
)
async def _(event):
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(URL) as request:
            ...
            deadlyevent = await edit_or_reply(event, "`fetching github info ...`")
