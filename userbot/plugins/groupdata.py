...
@deadlyub.deadly_cmd(
    ...
    info={
        ...
        "examples": "{tr}admins @deadly_userbot",
    },
)
async def _(event):
...
@deadlyub.deadly_cmd(
    ...
    info={
        ...
        "examples": "{tr}bots @deadly_userbot",
    },
)
async def _(event):
    "To get list of bots."
...
async def get_users(show):
    ...
    deadlyevent = await edit_or_reply(show, "`getting users list wait...`  ")
    try:
        ...
        mentions += " " + str(e) + "\n"
    await edit_or_reply(deadlyevent, mentions)
...
@deadlyub.deadly_cmd(
    ...
    info={
        ...
        "examples": "{tr}chatinfo @deadly_userbot",
    },
)
async def info(event):
    "To get group information"
    deadlyevent = await edit_or_reply(event, "`Analysing the chat...`")
    chat = await get_chatinfo(event, deadlyevent)
    if chat is None:
        return
    caption = await fetch_info(chat, event)
    try:
        await deadlyevent.edit(caption, parse_mode="html")
    except Exception as e:
        if BOTLOG:
        ...
        await deadlyevent.edit("`An unexpected error has occurred.`")


async def get_chatinfo(event, deadlyevent):
    ...
    try:
        ...
        try:
            ...
            await deadlyevent.edit("`Invalid channel/group`")
            return None
            ...
            await deadlyevent.edit("`Channel or supergroup doesn't exist`")
            return None
        except (TypeError, ValueError) as err:
            LOGS.info(err)
            await edit_delete(deadlyevent, "**Error:**\n__Can't fetch the chat__")
            return None
    return chat_info
