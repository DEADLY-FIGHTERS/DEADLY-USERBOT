...
@deadlyub.deadly_cmd(
    ...
    info={
        ...
        "usage": "{tr}ss <link>",
        "examples": "{tr}ss https://github.com/deadly-fighters/Deadly-Userbot",
    },
)
async def _(event):
    ...
    try:
        ...
        inputstr = input_str
        if cmd == "ss":
            deadlyurl = url(inputstr)
            if not deadlyurl:
                inputstr = "http://" + input_str
                deadlyurl = url(inputstr)
            if not deadlyurl:
                return await deadlyevent.edit("`The given input is not supported url`")
        if cmd == "gis":
            inputstr = "https://www.google.com/search?q=" + input_str
        driver.get(inputstr)
        await deadlyevent.edit("`Calculating Page Dimensions`")
        ...
        await deadlyevent.edit("`Stoppping Chrome Bin`")
        driver.close()
        ...
        await deadlyevent.edit(f"`{traceback.format_exc()}`")
...
@deadlyub.deadly_cmd(
    ...
    info={
        ...
        "examples": "{tr}scapture https://github.com/deadly-fighters/Deadly-Userbot",
    },
)
async def _(event):
    "To Take a screenshot of a website."
    ...
    if "image" in contentType:
        ...
        await deadlyevent.edit(f"`{response_api.text}`")
