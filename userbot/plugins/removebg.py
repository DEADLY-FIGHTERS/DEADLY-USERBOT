...
async def remove_background(event):
    ...
    if "image" in contentType:
        ...
        await edit_delete(deadlyevent, f"`{response.content.decode('UTF-8')}`", 5)
        return
    if cmd == "srmbg":
