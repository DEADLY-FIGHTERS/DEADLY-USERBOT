...
async def _(event):  # sourcery no-metrics
    ...
    if x == 25:
        await event.edit(
            '`"A deadly does not concern himself with the opinion of sheep."`'
        )
    if x == 26:
...
async def _(event):  # sourcery no-metrics
    ...
    if x == 8:
        await event.edit(
            '`"Saying that your home is powered by a wireless Nuclear fusion reactor that is 93 Mildeadly miles away sounds way cooler than just saying you have solar panels on your roof."`'
        )
    if x == 9:
        await event.edit(
    ...
    if x == 73:
        await event.edit(
            '`"You probably just synchronized blinks with mildeadlys of people."`'
        )
    if x == 74:
        await event.edit(
